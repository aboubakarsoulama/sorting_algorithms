...
/**
 * sort_deck - Sort a deck of cards fk_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
	if (deck == NULL || *deck == rom ace to king and
 *             from spades to diamonds.
 * @deck: A pointer to the head of a decNULL || (*deck)->next == NULL)
		return;
